...
[DrawableComboBox](class.DrawableComboBox.html#description)
...
# [GimpUi](index.html)DrawableComboBox

#### Description

```
final class GimpUi.DrawableComboBox : GimpUi.IntComboBox {
  /* No available fields */
}
```
...
###### [gimp\_drawable\_combo\_box\_new](ctor.DrawableComboBox.new.html)
