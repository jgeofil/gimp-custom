...
[ColorProfileStore](class.ColorProfileStore.html#description)
...
# [GimpUi](index.html)ColorProfileStore

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpcolorprofilestore.c#L41 "go to source location")

```
final class GimpUi.ColorProfileStore : Gtk.ListStore {
  /* No available fields */
}
```
...
###### [gimp\_color\_profile\_store\_new](ctor.ColorProfileStore.new.html)
...
###### [gimp\_color\_profile\_store\_add\_file](method.ColorProfileStore.add_file.html)
...
###### [GimpUi.ColorProfileStore:history](property.ColorProfileStore.history.html)
...
```
struct GimpUiColorProfileStoreClass {
