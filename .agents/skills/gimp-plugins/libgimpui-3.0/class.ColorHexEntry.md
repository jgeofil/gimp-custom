...
[ColorHexEntry](class.ColorHexEntry.html#description)
...
# [GimpUi](index.html)ColorHexEntry

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpcolorhexentry.c#L41 "go to source location")
...
###### [gimp\_color\_hex\_entry\_new](ctor.ColorHexEntry.new.html)
...
###### [gimp\_color\_hex\_entry\_get\_color](method.ColorHexEntry.get_color.html)

Retrieves the color value displayed by a `GimpColorHexEntry`.

since: 2.2

###### [gimp\_color\_hex\_entry\_set\_color](method.ColorHexEntry.set_color.html)
...
###### [GimpUi.ColorHexEntry::color-changed](signal.ColorHexEntry.color-changed.html)
...
```
struct GimpUiColorHexEntryClass {
