...
[Frame](class.Frame.html#description)
...
# [GimpUi](index.html)Frame

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpframe.c#L36 "go to source location")

```
class GimpUi.Frame : Gtk.Frame {
  parent_instance: GtkFrame
}
```
...
* [GimpIntRadioFrame](class.IntRadioFrame.html "IntRadioFrame")
...
###### [gimp\_frame\_new](ctor.Frame.new.html)
