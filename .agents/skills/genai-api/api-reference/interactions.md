...
_Alternative to \`agent_config\`. Only applicable when \`model\` is set._
...
- `512`
  ...
  _Alternative to \`generation_config\`. Only applicable when \`agent\` is set._
...
- [Request body](https://ai.google.dev/api/interactions-api#CreateWebhook.request_body)
- [Response](https://ai.google.dev/api/interactions-api#CreateWebhook.response)
...
subscribed_events array (object or string) (required) Required. The events that the webhook is subscribed to.
Available events:
...
subscribed_events array (object or string) (optional) Required. The events that the webhook is subscribed to.
Available events:
...
- video.generated
  ...
  signing_secrets SigningSecret (optional) Output only. The signing secrets associated with this webhook.
...
<iframe src="https:///frame/api/interactions-api_f669f8734c48d0b997950727005ce01154a4a644d4815985dbf52e34a2de8c38.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
- [Path / Query parameters](https://ai.google.dev/api/interactions-api#ListWebhooks.PATH_PARAMETERS)
- [Response](https://ai.google.dev/api/interactions-api#ListWebhooks.response)
...
If successful, the response body contains data with the following structure:
webhooks Webhook (optional) The webhooks.
A Webhook resource.
...
<iframe src="https:///frame/api/interactions-api_f6b0311fd35e32ced0fc0f9753399f557424c984e151cd6e4a1f535c81b8cd01.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
- [Path / Query parameters](https://ai.google.dev/api/interactions-api#GetWebhook.PATH_PARAMETERS)
- [Response](https://ai.google.dev/api/interactions-api#GetWebhook.response)
...
<iframe src="https:///frame/api/interactions-api_bf5bb657875d7542a20a71b83fab6c7773c90c0df72740e2d003f2fccdcc5de8.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
- [Path / Query parameters](https://ai.google.dev/api/interactions-api#UpdateWebhook.PATH_PARAMETERS)
- [Request body](https://ai.google.dev/api/interactions-api#UpdateWebhook.request_body)
- [Response](https://ai.google.dev/api/interactions-api#UpdateWebhook.response)
...
subscribed_events array (object or string) (optional) Optional. The events that the webhook is subscribed to.
Available events:
...
<iframe src="https:///frame/api/interactions-api_8a9189d15fba7ae8e9579c3a8685d064fa3c4d801dc52a3405aaadb71796409a.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
- [Path / Query parameters](https://ai.google.dev/api/interactions-api#DeleteWebhook.PATH_PARAMETERS)
- [Response](https://ai.google.dev/api/interactions-api#DeleteWebhook.response)
...
<iframe src="https:///frame/api/interactions-api_db080921e9420d499a2f8b55744f5d62d5e52eb6c7afd75f3a092750f44a4640.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
- [Path / Query parameters](https://ai.google.dev/api/interactions-api#RotateSigningSecret.PATH_PARAMETERS)
- [Request body](https://ai.google.dev/api/interactions-api#RotateSigningSecret.request_body)
- [Response](https://ai.google.dev/api/interactions-api#RotateSigningSecret.response)
...
<iframe src="https:///frame/api/interactions-api_818464b835d62e654dacde4866230273564a79efcc41e59e39847788b77694ad.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
- [Path / Query parameters](https://ai.google.dev/api/interactions-api#PingWebhook.PATH_PARAMETERS)
- [Request body](https://ai.google.dev/api/interactions-api#PingWebhook.request_body)
- [Response](https://ai.google.dev/api/interactions-api#PingWebhook.response)
...
<iframe src="https:///frame/api/interactions-api_b95bbd961cbc1f974e712ccae89211dd075b24ac2cc8a650651a22545b5b2124.frame" class="framebox inherit-locale " allow="clipboard-write https://" allowfullscreen is-upgraded></iframe>
...
user_metadata object (optional) Optional. The user metadata that will be returned on each event emission to the
webhooks.
steps Step (optional) Output only. The steps that make up the interaction.
...
partial_arguments string (optional) No description provided.
event_id string (optional) The event_id token to be used to resume the interaction stream, from
this event.
StepStop <br />
