...
[PathComboBox](class.PathComboBox.html#description)
...
# [GimpUi](index.html)PathComboBox

#### Description

```
final class GimpUi.PathComboBox : GimpUi.IntComboBox {
  /* No available fields */
}
```
...
###### [gimp\_path\_combo\_box\_new](ctor.PathComboBox.new.html)
