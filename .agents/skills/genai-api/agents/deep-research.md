...
- **Prompt for unknowns:** Instruct the agent on how to handle missing data. For example, add _"If specific figures for 2025 are not available,
  explicitly state they are projections or unavailable rather than
  estimating"_ to your prompt.
