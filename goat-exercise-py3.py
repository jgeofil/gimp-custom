...
class Goat(Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        ...
        procedure.set_documentation(_("Plug-in example in Python 3"), _("Plug-in example in Python 3"), name)
    ...
    def run(self, procedure, run_mode, image, drawables, config, run_data):
        ...
        if run_mode == Gimp.RunMode.INTERACTIVE:
            ...
            dialog = GimpUi.Dialog(use_header_bar=True, title=_("Plug-In Example in Python 3"), role="goat-exercise-Python3")
