...
`batch.model` `string` Required. The name of the `Model` to use for generating the completion.
...
Fields `batch.name` `string` Output only. Identifier. Resource name of the batch.

Format: `batches/{batchId}`.
`batch.displayName` `string` Required. The user-defined name of this batch.
`batch.inputConfig` ``object (`https://ai.google.dev/api/batch-api#InputConfig`)`` Required. Input configuration of the instances on which batch processing are performed.
`batch.output` ``object (`https://ai.google.dev/api/batch-api#GenerateContentBatchOutput`)`` Output only. The output of the batch request.
`batch.createTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch was created.

Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: `"2014-10-02T15:01:23Z"`, `"2014-10-02T15:01:23.045123456Z"` or `"2014-10-02T15:01:23+05:30"`.
`batch.endTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch processing completed.

Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: `"2014-10-02T15:01:23Z"`, `"2014-10-02T15:01:23.045123456Z"` or `"2014-10-02T15:01:23+05:30"`.
`batch.updateTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch was last updated.

Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: `"2014-10-02T15:01:23Z"`, `"2014-10-02T15:01:23.045123456Z"` or `"2014-10-02T15:01:23+05:30"`.
`batch.batchStats` ``object (`https://ai.google.dev/api/batch-api#BatchStats`)`` Output only. Stats about the batch.
...
Format: `batches/{batchId}`.
`batch.displayName` `string` Required. The user-defined name of this batch.
`batch.inputConfig` ``object (`https://ai.google.dev/api/embeddings#InputEmbedContentConfig`)`` Required. Input configuration of the instances on which batch processing are performed.
`batch.output` ``object (`https://ai.google.dev/api/embeddings#EmbedContentBatchOutput`)`` Output only. The output of the batch request.
`batch.createTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch was created.
...
`name` `string` The name of the operation resource. It takes the form `batches/{batches}`.
...
`name` `string` The name of the operation's parent resource. It takes the form `batches`.
...
`name` `string` The name of the operation resource to be cancelled. It takes the form `batches/{batches}`.
...
`name` `string` The name of the operation resource to be deleted. It takes the form `batches/{batches}`.
...
Format: `models/{model}`.
`name` `string` Output only. Identifier. Resource name of the batch.

Format: `batches/{batchId}`.
`displayName` `string` Required. The user-defined name of this batch.
`inputConfig` ``object (`https://ai.google.dev/api/batch-api#InputConfig`)`` Required. Input configuration of the instances on which batch processing are performed.
`output` ``object (`https://ai.google.dev/api/batch-api#GenerateContentBatchOutput`)`` Output only. The output of the batch request.
`createTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch was created.

Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: `"2014-10-02T15:01:23Z"`, `"2014-10-02T15:01:23.045123456Z"` or `"2014-10-02T15:01:23+05:30"`.
`endTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch processing completed.

Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: `"2014-10-02T15:01:23Z"`, `"2014-10-02T15:01:23.045123456Z"` or `"2014-10-02T15:01:23+05:30"`.
`updateTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Output only. The time at which the batch was last updated.

Uses RFC 3339, where generated output will always be Z-normalized and use 0, 3, 6 or 9 fractional digits. Offsets other than "Z" are also accepted. Examples: `"2014-10-02T15:01:23Z"`, `"2014-10-02T15:01:23.045123456Z"` or `"2014-10-02T15:01:23+05:30"`.
`batchStats` ``object (`https://ai.google.dev/api/batch-api#BatchStats`)`` Output only. Stats about the batch.
`state` ``enum (`https://ai.google.dev/api/batch-api#v1beta.BatchState`)`` Output only. The state of the batch.
`priority` `string (https://developers.google.com/discovery/v1/type-format format)` Optional. The priority of the batch. Batches with a higher priority value will be processed before batches with a lower priority value. Negative values are allowed. Default is 0.
...
Fields `requests[]` ``object (`https://ai.google.dev/api/batch-api#InlinedRequest`)`` Required. The requests to be processed in the batch.
...
Fields `request` ``object (`https://ai.google.dev/api/batch-api#GenerateContentRequest`)`` Required. The request to be processed in the batch.
`metadata` ``object (`https://protobuf.dev/reference/protobuf/google.protobuf#struct` format)`` Optional. The metadata to be associated with the request.
...
Fields `inlinedResponses[]` ``object (`https://ai.google.dev/api/batch-api#InlinedResponse`)`` Output only. The responses to the requests in the batch.
...
Fields `requestCount` `string (https://developers.google.com/discovery/v1/type-format format)` Output only. The number of requests in the batch.
`successfulRequestCount` `string (https://developers.google.com/discovery/v1/type-format format)` Output only. The number of requests that were successfully processed.
`failedRequestCount` `string (https://developers.google.com/discovery/v1/type-format format)` Output only. The number of requests that failed to be processed.
`pendingRequestCount` `string (https://developers.google.com/discovery/v1/type-format format)` Output only. The number of requests that are still pending processing.
