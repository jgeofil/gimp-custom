...
[EnumComboBox](class.EnumComboBox.html#description)
...
# [GimpUi](index.html)EnumComboBox

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpenumcombobox.c#L36 "go to source location")

```
class GimpUi.EnumComboBox : GimpUi.IntComboBox {
  parent_instance: GimpIntComboBox
}
```
...
###### [gimp\_enum\_combo\_box\_new](ctor.EnumComboBox.new.html)
...
###### [gimp\_enum\_combo\_box\_new\_with\_model](ctor.EnumComboBox.new_with_model.html)
...
###### [gimp\_enum\_combo\_box\_set\_icon\_prefix](method.EnumComboBox.set_icon_prefix.html)
...
###### [GimpUi.EnumComboBox:model](property.EnumComboBox.model.html)
...
```
struct GimpUiEnumComboBoxClass {
