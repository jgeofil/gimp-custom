...
[ChannelComboBox](class.ChannelComboBox.html#description)
...
# [GimpUi](index.html)ChannelComboBox

#### Description

```
final class GimpUi.ChannelComboBox : GimpUi.IntComboBox {
  /* No available fields */
}
```
...
###### [gimp\_channel\_combo\_box\_new](ctor.ChannelComboBox.new.html)
