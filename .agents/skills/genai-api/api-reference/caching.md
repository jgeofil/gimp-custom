...
Fields `contents[]` ``object (`https://ai.google.dev/api/caching#Content`)`` Optional. Input only. Immutable. The content to cache.
`tools[]` ``object (`https://ai.google.dev/api/caching#Tool`)`` Optional. Input only. Immutable. A list of `Tools` the model may use to generate the next response
`expiration` `Union type` Specifies when this resource will expire. `expiration` can be only one of the following: `expireTime` ``string (`https://protobuf.dev/reference/protobuf/google.protobuf#timestamp` format)`` Timestamp in UTC of when this resource is considered expired. This is _always_ provided on output, regardless of what was sent on input.
...
`systemInstruction` ``object (`https://ai.google.dev/api/caching#Content`)`` Optional. Input only. Immutable. Developer set system instruction. Currently text only.
...
- [ToolCall](https://ai.google.dev/api/caching#ToolCall)
    - [JSON representation](https://ai.google.dev/api/caching#ToolCall.SCHEMA_REPRESENTATION)
- [ToolType](https://ai.google.dev/api/caching#ToolType)
- [ToolResponse](https://ai.google.dev/api/caching#ToolResponse)
    - [JSON representation](https://ai.google.dev/api/caching#ToolResponse.SCHEMA_REPRESENTATION)
...
- [MediaResolution](https://ai.google.dev/api/caching#MediaResolution)
    - [JSON representation](https://ai.google.dev/api/caching#MediaResolution.SCHEMA_REPRESENTATION)
- [Level](https://ai.google.dev/api/caching#Level)
...
- [SearchTypes](https://ai.google.dev/api/caching#SearchTypes)
    - [JSON representation](https://ai.google.dev/api/caching#SearchTypes.SCHEMA_REPRESENTATION)
- [WebSearch](https://ai.google.dev/api/caching#WebSearch)
- [ImageSearch](https://ai.google.dev/api/caching#ImageSearch)
...
- [McpServer](https://ai.google.dev/api/caching#McpServer)
    - [JSON representation](https://ai.google.dev/api/caching#McpServer.SCHEMA_REPRESENTATION)
- [StreamableHttpTransport](https://ai.google.dev/api/caching#StreamableHttpTransport)
    - [JSON representation](https://ai.google.dev/api/caching#StreamableHttpTransport.SCHEMA_REPRESENTATION)
...
Fields `parts[]` ``object (`https://ai.google.dev/api/caching#Part`)`` Ordered `Parts` that constitute a single message. Parts may have different MIME types.
...
`mediaResolution` ``object (`https://ai.google.dev/api/caching#MediaResolution`)`` Optional. Media resolution for the input media.
`data` `Union type` `data` can be only one of the following: `text` `string` Inline text.
`inlineData` ``object (`https://ai.google.dev/api/caching#Blob`)`` Inline media bytes.
`functionCall` ``object (`https://ai.google.dev/api/caching#FunctionCall`)`` A predicted `FunctionCall` returned from the model that contains a string representing the `FunctionDeclaration.name` with the arguments and their values.
`functionResponse` ``object (`https://ai.google.dev/api/caching#FunctionResponse`)`` The result output of a `FunctionCall` that contains a string representing the `FunctionDeclaration.name` and a structured JSON object containing any output from the function is used as context to the model.
`fileData` ``object (`https://ai.google.dev/api/caching#FileData`)`` URI based data.
`executableCode` ``object (`https://ai.google.dev/api/caching#ExecutableCode`)`` Code generated by the model that is meant to be executed.
`codeExecutionResult` ``object (`https://ai.google.dev/api/caching#CodeExecutionResult`)`` Result of executing the `ExecutableCode`.
`toolCall` ``object (`https://ai.google.dev/api/caching#ToolCall`)`` Server-side tool call. This field is populated when the model predicts a tool invocation that should be executed on the server. The client is expected to echo this message back to the API.
`toolResponse` ``object (`https://ai.google.dev/api/caching#ToolResponse`)`` The output from a server-side `ToolCall` execution. This field is populated by the client with the results of executing the corresponding `ToolCall`.
`metadata` `Union type` Controls extra preprocessing of data. `metadata` can be only one of the following: `videoMetadata` ``object (`https://ai.google.dev/api/caching#VideoMetadata`)`` Optional. Video metadata. The metadata should only be specified while the video data is presented in inlineData or fileData.

| JSON representation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ``{ "thought": boolean, "thoughtSignature": string, "partMetadata": { object }, "mediaResolution": { object (`https://ai.google.dev/api/caching#MediaResolution`) }, // data "text": string, "inlineData": { object (`https://ai.google.dev/api/caching#Blob`) }, "functionCall": { object (`https://ai.google.dev/api/caching#FunctionCall`) }, "functionResponse": { object (`https://ai.google.dev/api/caching#FunctionResponse`) }, "fileData": { object (`https://ai.google.dev/api/caching#FileData`) }, "executableCode": { object (`https://ai.google.dev/api/caching#ExecutableCode`) }, "codeExecutionResult": { object (`https://ai.google.dev/api/caching#CodeExecutionResult`) }, "toolCall": { object (`https://ai.google.dev/api/caching#ToolCall`) }, "toolResponse": { object (`https://ai.google.dev/api/caching#ToolResponse`) } // Union type // metadata "videoMetadata": { object (`https://ai.google.dev/api/caching#VideoMetadata`) } // Union type }`` |
...
Fields `data` `Union type` The data of the function response part. `data` can be only one of the following: `inlineData` ``object (`https://ai.google.dev/api/caching#FunctionResponseBlob`)`` Inline media bytes.
...
`language` ``enum (`https://ai.google.dev/api/caching#Language`)`` Required. Programming language of the `code`.
`code` `string` Required. The code to be executed.

| JSON representation                                                                                   |
| ----------------------------------------------------------------------------------------------------- |
| ``{ "id": string, "language": enum (`https://ai.google.dev/api/caching#Language`), "code": string }`` |
...
`outcome` ``enum (`https://ai.google.dev/api/caching#Outcome`)`` Required. Outcome of the code execution.
`output` `string` Optional. Contains stdout when code execution is successful, stderr or other description otherwise.

| JSON representation                                                                                   |
| ----------------------------------------------------------------------------------------------------- |
| ``{ "id": string, "outcome": enum (`https://ai.google.dev/api/caching#Outcome`), "output": string }`` |
...
`toolType` ``enum (`https://ai.google.dev/api/caching#ToolType`)`` Required. The type of tool that was called.
...
| JSON representation                                                                                       |
| --------------------------------------------------------------------------------------------------------- |
| ``{ "id": string, "toolType": enum (`https://ai.google.dev/api/caching#ToolType`), "args": { object } }`` |
...
`toolType` ``enum (`https://ai.google.dev/api/caching#ToolType`)`` Required. The type of tool that was called, matching the `toolType` in the corresponding `ToolCall`.
`response` ``object (`https://protobuf.dev/reference/protobuf/google.protobuf#struct` format)`` Optional. The tool response.

| JSON representation                                                                                           |
| ------------------------------------------------------------------------------------------------------------- |
| ``{ "id": string, "toolType": enum (`https://ai.google.dev/api/caching#ToolType`), "response": { object } }`` |
...
Fields `value` `Union type` The media resolution level. `value` can be only one of the following: `level` ``enum (`https://ai.google.dev/api/caching#Level`)`` The tokenization quality used for given media. for Gemini API support .

| JSON representation                                                                      |
| ---------------------------------------------------------------------------------------- |
| ``{ // value "level": enum (`https://ai.google.dev/api/caching#Level`) // Union type }`` |
...
`googleSearchRetrieval` ``object (`https://ai.google.dev/api/caching#GoogleSearchRetrieval`)`` Optional. Retrieval tool that is powered by Google search.
`codeExecution` ``object (`https://ai.google.dev/api/caching#CodeExecution`)`` Optional. Enables the model to execute code as part of generation.
`googleSearch` ``object (`https://ai.google.dev/api/caching#GoogleSearch`)`` Optional. GoogleSearch tool type. Tool to support Google Search in Model. Powered by Google.
`computerUse` ``object (`https://ai.google.dev/api/caching#ComputerUse`)`` Optional. Tool to support the model interacting directly with the computer. If enabled, it automatically populates computer-use specific Function Declarations.
`urlContext` ``object (`https://ai.google.dev/api/caching#UrlContext`)`` Optional. Tool to support URL context retrieval.
`fileSearch` ``object (`https://ai.google.dev/api/caching#FileSearch`)`` Optional. FileSearch tool type. Tool to retrieve knowledge from Semantic Retrieval corpora.
`mcpServers[]` ``object (`https://ai.google.dev/api/caching#McpServer`)`` Optional. MCP Servers to connect to.
`googleMaps` ``object (`https://ai.google.dev/api/caching#GoogleMaps`)`` Optional. Tool that allows grounding the model's response with geospatial context related to the user's query.

| JSON representation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ``{ "functionDeclarations": [ { object (`https://ai.google.dev/api/caching#FunctionDeclaration`) } ], "googleSearchRetrieval": { object (`https://ai.google.dev/api/caching#GoogleSearchRetrieval`) }, "codeExecution": { object (`https://ai.google.dev/api/caching#CodeExecution`) }, "googleSearch": { object (`https://ai.google.dev/api/caching#GoogleSearch`) }, "computerUse": { object (`https://ai.google.dev/api/caching#ComputerUse`) }, "urlContext": { object (`https://ai.google.dev/api/caching#UrlContext`) }, "fileSearch": { object (`https://ai.google.dev/api/caching#FileSearch`) }, "mcpServers": [ { object (`https://ai.google.dev/api/caching#McpServer`) } ], "googleMaps": { object (`https://ai.google.dev/api/caching#GoogleMaps`) } }`` |
...
`behavior` ``enum (`https://ai.google.dev/api/caching#Behavior`)`` Optional. Specifies the function Behavior. Currently only supported by the BidiGenerateContent method.
`parameters` ``object (`https://ai.google.dev/api/caching#Schema`)`` Optional. Describes the parameters to this function. Reflects the Open API 3.03 Parameter Object string Key: the name of the parameter. Parameter names are case sensitive. Schema Value: the Schema defining the type used for the parameter.
...
`response` ``object (`https://ai.google.dev/api/caching#Schema`)`` Optional. Describes the output from this function in JSON Schema format. Reflects the Open API 3.03 Response Object. The Schema defines the type used for the response value of the function.
...
Fields `type` ``enum (`https://ai.google.dev/api/caching#Type`)`` Required. Data type.
...
`properties` ``map (key: string, value: object (`https://ai.google.dev/api/caching#Schema`))`` Optional. Properties of Type.OBJECT.
...
`anyOf[]` ``object (`https://ai.google.dev/api/caching#Schema`)`` Optional. The value should be validated against any (one or more) of the subschemas in the list.
...
`items` ``object (`https://ai.google.dev/api/caching#Schema`)`` Optional. Schema of the elements of Type.ARRAY.
...
Fields `dynamicRetrievalConfig` ``object (`https://ai.google.dev/api/caching#DynamicRetrievalConfig`)`` Specifies the dynamic retrieval configuration for the given source.
...
Fields `mode` ``enum (`https://ai.google.dev/api/caching#Mode`)`` The mode of the predictor to be used in dynamic retrieval.
...
Fields `timeRangeFilter` ``object (`https://ai.google.dev/api/caching#Interval`)`` Optional. Filter search results to a specific time range. If customers set a start time, they must set an end time (and vice versa).
`searchTypes` ``object (`https://ai.google.dev/api/caching#SearchTypes`)`` Optional. The set of search types to enable. If not set, web search is enabled by default.

| JSON representation                                                                                                                                               |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ``{ "timeRangeFilter": { object (`https://ai.google.dev/api/caching#Interval`) }, "searchTypes": { object (`https://ai.google.dev/api/caching#SearchTypes`) } }`` |
...
Fields `webSearch` ``object (`https://ai.google.dev/api/caching#WebSearch`)`` Optional. Enables web search. Only text results are returned.
`imageSearch` ``object (`https://ai.google.dev/api/caching#ImageSearch`)`` Optional. Enables image search. Image bytes are returned.

| JSON representation                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ``{ "webSearch": { object (`https://ai.google.dev/api/caching#WebSearch`) }, "imageSearch": { object (`https://ai.google.dev/api/caching#ImageSearch`) } }`` |
...
Fields `environment` ``enum (`https://ai.google.dev/api/caching#Environment`)`` Required. The environment being operated.
...
| JSON representation                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ``{ "name": string, // transport "streamableHttpTransport": { object (`https://ai.google.dev/api/caching#StreamableHttpTransport`) } // Union type }`` |
...
Fields `mode` ``enum (`https://ai.google.dev/api/caching#Mode_1`)`` Optional. Specifies the mode in which function calling should execute. If unspecified, the default value will be set to AUTO.
