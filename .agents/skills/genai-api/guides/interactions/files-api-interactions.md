...
- ### [Prompt design fundamentals](https://ai.google.dev/gemini-api/docs/interactions/files#specific-instructions)
...
- ### [Troubleshooting your multimodal prompt](https://ai.google.dev/gemini-api/docs/interactions/files#troubleshooting)
    ...
    - **Tuning the sampling parameters:** Experiment with different temperature settings and top-k selections to adjust the model's creativity.
        ...
        > [!NOTE]
        > When using Gemini 3 models, we strongly recommend keeping the `temperature` at its default value of 1.0. Changing the temperature (setting it to a value less than 1.0) may lead to unexpected behavior, such as looping or degraded performance, particularly in complex mathematical or reasoning tasks.
...
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/timetable.png) Describe this image. | The image shows an airport arrivals and departures board. |

<br />

| **Updated prompt**                                                                                                                                                                  | **Improved response**                                                                                                                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Travel timetable](https://ai.google.dev/static/gemini-api/docs/interactions/images/timetable.png) Parse the time and city from the airport board shown in this image into a list. | <br /> - 10:50 Moscow - 11:05 Edinburgh - 11:05 London - 11:10 Bucharest - 11:30 Kiev - 11:35 Dublin - 11:45 East Midlands - 12:15 Sofia - 12:30 London - 12:30 Newcastle - 12:40 St Petersburg - 12:40 London - 12:45 Manchester |
...
| **Prompt**                                                                                                                                     | **Model response**                                                        |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| ![Travel timetable](https://ai.google.dev/static/gemini-api/docs/interactions/images/redeemer.png) Determine the city along with the landmark. | The landmark is the Christ the Redeemer statue in Rio de Janeiro, Brazil. |

<br />

| **Updated prompt**                                                                                                                       | **Improved response**                                      |
| ---------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| Determine the city along with the landmark. ![colosseum](https://ai.google.dev/static/gemini-api/docs/interactions/images/colosseum.png) | city: Rome, landmark: the Colosseum.                       |
| ![Forbidden City](https://ai.google.dev/static/gemini-api/docs/interactions/images/forbidden-city.png)                                   | city: Beijing, landmark: Forbidden City                    |
| ![forbidden-city](https://ai.google.dev/static/gemini-api/docs/interactions/images/redeemer.png)                                         | city: Rio de Janeiro, landmark: Christ the Redeemer statue |
...
| **Prompt**                                                                                                           | **Response** |
| -------------------------------------------------------------------------------------------------------------------- | ------------ |
| ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/math.jpg) What is the 4th term in the sequence? | -135         |
...
| **Updated prompt**                                                                                                                       | **Improved response**                                                                                                                                                               |
| ---------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/math.jpg) What is the 4th term in the sequence? Think step by step. | The first term is 15. The second term is b(1) \* (-3) = 15 \* (-3) = -45. The third term is b(2) \* (-3) = -45 \* (-3) = 135. The fourth term is b(3) \* (-3) = 135 \* (-3) = -405. |
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/tea-set.png) What's a snack I can make in 1 minute that would go well with this? | ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/tea-set.png) Describe what's in this image. |
...
| Prompt                                                                                                                                                | Prompt for troubleshooting                                                                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/tea-set.png) What's a snack I can make in 1 minute that would go well with this? | ![](https://ai.google.dev/static/gemini-api/docs/interactions/images/tea-set.png) What's a snack I can make in 1 minute that would go well with this? Please explain why. |

## What's next

- Try writing your own multimodal prompts using [Google AI
  Studio](http://aistudio.google.com).
- For information on using the Gemini Files API for uploading media files and including them in your prompts, see the [Vision](https://ai.google.dev/gemini-api/docs/interactions/vision), [Audio](https://ai.google.dev/gemini-api/docs/interactions/audio), and [Document processing](https://ai.google.dev/gemini-api/docs/interactions/document-processing) guides.
