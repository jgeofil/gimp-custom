...
# [GimpUi](index.html)Dialog

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpdialog.c#L46 "go to source location")

```
class GimpUi.Dialog : Gtk.Dialog {
  parent_instance: GtkDialog
}
```

Constructors for `GtkDialog`‘s and action\_areas as well as other
...
* [GimpProcBrowserDialog](class.ProcBrowserDialog.html "ProcBrowserDialog")
...
###### [gimp\_dialog\_new](ctor.Dialog.new.html)

Creates a new `GimpDialog` widget.

###### [gimp\_dialog\_new\_valist](ctor.Dialog.new_valist.html)
