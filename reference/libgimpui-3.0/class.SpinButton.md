...
[SpinButton](class.SpinButton.html#description)
...
# [GimpUi](index.html)SpinButton

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpspinbutton.c#L37 "go to source location")

```
class GimpUi.SpinButton : Gtk.SpinButton {
  parent_instance: GtkSpinButton
}
```
...
* [GimpSpinScale](class.SpinScale.html "SpinScale")
...
###### [gimp\_spin\_button\_new](ctor.SpinButton.new.html)

Creates a new `GimpSpinButton`.

since: 2.10.10

###### [gimp\_spin\_button\_new\_with\_range](ctor.SpinButton.new_with_range.html)
...
`parent_class: GtkSpinButtonClass`
:   No description available.
