...
[ColorProfileChooserDialog](class.ColorProfileChooserDialog.html#description)
...
# [GimpUi](index.html)ColorProfileChooserDialog

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpcolorprofilechooserdialog.c#L44 "go to source location")

```
final class GimpUi.ColorProfileChooserDialog : Gtk.FileChooserDialog {
  /* No available fields */
}
```
...
###### [gimp\_color\_profile\_chooser\_dialog\_new](ctor.ColorProfileChooserDialog.new.html)
...
###### Gtk-3.0.FileChooser:action

No description available.

###### Gtk-3.0.FileChooser:create-folders
...
###### Gtk-3.0.FileChooser:do-overwrite-confirmation
...
###### Gtk-3.0.FileChooser:extra-widget

No description available.

###### Gtk-3.0.FileChooser:filter

No description available.

###### Gtk-3.0.FileChooser:local-only

No description available.

###### Gtk-3.0.FileChooser:preview-widget

No description available.

###### Gtk-3.0.FileChooser:preview-widget-active

No description available.

###### Gtk-3.0.FileChooser:select-multiple

No description available.

###### Gtk-3.0.FileChooser:show-hidden

No description available.

###### Gtk-3.0.FileChooser:use-preview-label
...
```
struct GimpUiColorProfileChooserDialogClass {
...
`parent_class: GtkFileChooserDialogClass`
:   No description available.
