...
[ChainButton](class.ChainButton.html#description)
...
# [GimpUi](index.html)ChainButton

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpchainbutton.c#L34 "go to source location")

```
final class GimpUi.ChainButton : Gtk.Grid {
  /* No available fields */
}
```
...
###### [gimp\_chain\_button\_new](ctor.ChainButton.new.html)

Creates a new `GimpChainButton` widget.

#### Instance methods

###### [gimp\_chain\_button\_get\_active](method.ChainButton.get_active.html)

Checks the state of the `GimpChainButton`.

###### [gimp\_chain\_button\_get\_button](method.ChainButton.get_button.html)

No description available.

since: 3.0

###### [gimp\_chain\_button\_get\_icon\_size](method.ChainButton.get_icon_size.html)

Gets the icon size of the `GimpChainButton`.

since: 2.10.10

###### [gimp\_chain\_button\_set\_active](method.ChainButton.set_active.html)
...
###### [gimp\_chain\_button\_set\_icon\_size](method.ChainButton.set_icon_size.html)
...
###### [GimpUi.ChainButton:active](property.ChainButton.active.html)

The toggled state of the chain button.

since: 2.10.10

###### [GimpUi.ChainButton:icon-size](property.ChainButton.icon-size.html)

The chain button icon size.

since: 2.10.10

###### [GimpUi.ChainButton:position](property.ChainButton.position.html)
...
###### [GimpUi.ChainButton::toggled](signal.ChainButton.toggled.html)
