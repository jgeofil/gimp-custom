...
[Labeled](class.Labeled.html#description)
...
# [GimpUi](index.html)Labeled

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimplabeled.c#L33 "go to source location")

```
class GimpUi.Labeled : Gtk.Grid {
...
* [GimpLabelColor](class.LabelColor.html "LabelColor")
* [GimpLabelEntry](class.LabelEntry.html "LabelEntry")
* [GimpLabelIntWidget](class.LabelIntWidget.html "LabelIntWidget")
* [GimpLabelSpin](class.LabelSpin.html "LabelSpin")
* [GimpLabelStringWidget](class.LabelStringWidget.html "LabelStringWidget")
...
###### [GimpUi.Labeled::mnemonic-widget-changed](signal.Labeled.mnemonic-widget-changed.html)
...
```
struct GimpUiLabeledClass {
  GtkGridClass parent_class;
  void (* mnemonic_widget_changed) (
    GimpLabeled* labeled,
    GtkWidget* widget
  );
  GtkWidget* (* populate) (
...
`mnemonic_widget_changed: void (* mnemonic_widget_changed) ( GimpLabeled* labeled, GtkWidget* widget )`
:   No description available.

`populate: GtkWidget* (* populate) ( GimpLabeled* labeled, gint* x, gint* y, gint* width, gint* height )`
:   No description available.
...
###### [GimpUi.LabeledClass.mnemonic\_widget\_changed](vfunc.Labeled.mnemonic_widget_changed.html)

No description available.

###### [GimpUi.LabeledClass.populate](vfunc.Labeled.populate.html)
