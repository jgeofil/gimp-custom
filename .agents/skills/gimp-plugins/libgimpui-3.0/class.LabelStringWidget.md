...
[LabelStringWidget](class.LabelStringWidget.html#description)
...
[value-changed](signal.LabelStringWidget.value-changed.html)

Generated by [gi-docgen](https://gitlab.gnome.org/GNOME/gi-docgen) 2023.1

### Class

# [GimpUi](index.html)LabelStringWidget

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimplabelstringwidget.c#L34 "go to source location")

```
final class GimpUi.LabelStringWidget : GimpUi.Labeled {
  /* No available fields */
}
```
...
###### [gimp\_label\_string\_widget\_new](ctor.LabelStringWidget.new.html)
...
###### [gimp\_label\_string\_widget\_get\_widget](method.LabelStringWidget.get_widget.html)
...
###### [GimpUi.LabelStringWidget:value](property.LabelStringWidget.value.html)

The currently set value.

since: 3.0

###### [GimpUi.LabelStringWidget:widget](property.LabelStringWidget.widget.html)
...
###### [GimpUi.LabelStringWidget::value-changed](signal.LabelStringWidget.value-changed.html)
...
```
struct GimpUiLabelStringWidgetClass {
