...
[ScaleEntry](class.ScaleEntry.html#description)
...
# [GimpUi](index.html)ScaleEntry

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpscaleentry.c#L34 "go to source location")

```
class GimpUi.ScaleEntry : GimpUi.LabelSpin {
  parent_instance: GimpLabelSpin
}
```
...
* [GimpLabelSpin](class.LabelSpin.html "LabelSpin")
...
* [GimpColorScaleEntry](class.ColorScaleEntry.html "ColorScaleEntry")
...
###### [gimp\_scale\_entry\_new](ctor.ScaleEntry.new.html)
...
###### [gimp\_scale\_entry\_get\_logarithmic](method.ScaleEntry.get_logarithmic.html)

No description available.

since: 2.2

###### [gimp\_scale\_entry\_get\_range](method.ScaleEntry.get_range.html)

This function returns the `GtkRange` packed in `entry`. This can be
useful if you need to customize some aspects of the widget.

###### [gimp\_scale\_entry\_set\_bounds](method.ScaleEntry.set_bounds.html)
...
###### [gimp\_scale\_entry\_set\_logarithmic](method.ScaleEntry.set_logarithmic.html)
...
##### Methods inherited from [GimpLabelSpin](class.LabelSpin.html) (5)
...
##### Properties inherited from [GimpLabelSpin](class.LabelSpin.html) (4)
...
##### Signals inherited from [GimpLabelSpin](class.LabelSpin.html) (1)

###### [GimpLabelSpin::value-changed](signal.LabelSpin.value-changed.html)
...
```
struct GimpUiScaleEntryClass {
  GimpLabelSpinClass parent_class;
  GtkWidget* (* new_range_widget) (
...
`parent_class: GimpLabelSpinClass`
:   No description available.

`new_range_widget: GtkWidget* (* new_range_widget) ( GtkAdjustment* adjustment )`
:   No description available.
