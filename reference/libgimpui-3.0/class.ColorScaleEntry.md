...
[ColorScaleEntry](class.ColorScaleEntry.html#description)
...
# [GimpUi](index.html)ColorScaleEntry

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpcolorscaleentry.c#L34 "go to source location")

```
final class GimpUi.ColorScaleEntry : GimpUi.ScaleEntry {
  /* No available fields */
}
```
...
###### [gimp\_color\_scale\_entry\_new](ctor.ColorScaleEntry.new.html)

No description available.

#### Instance methods

##### Methods inherited from [GimpScaleEntry](class.ScaleEntry.html) (4)
...
```
struct GimpUiColorScaleEntryClass {
...
`parent_class: GimpScaleEntryClass`
:   No description available.
