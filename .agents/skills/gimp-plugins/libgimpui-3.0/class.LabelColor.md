...
[LabelColor](class.LabelColor.html#description)
...
# [GimpUi](index.html)LabelColor

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimplabelcolor.c#L35 "go to source location")

```
final class GimpUi.LabelColor : GimpUi.Labeled {
  /* No available fields */
}
```
...
###### [gimp\_label\_color\_new](ctor.LabelColor.new.html)
...
###### [gimp\_label\_color\_get\_color\_widget](method.LabelColor.get_color_widget.html)
...
###### [gimp\_label\_color\_get\_value](method.LabelColor.get_value.html)

This function returns the value shown by `color`.

###### [gimp\_label\_color\_is\_editable](method.LabelColor.is_editable.html)

This function tells whether the color widget allows to edit the color.

###### [gimp\_label\_color\_set\_editable](method.LabelColor.set_editable.html)

Changes the editability of the color.

###### [gimp\_label\_color\_set\_value](method.LabelColor.set_value.html)
...
###### [GimpUi.LabelColor:editable](property.LabelColor.editable.html)

Whether the color can be edited.

since: 3.0

###### [GimpUi.LabelColor:value](property.LabelColor.value.html)
...
###### [GimpUi.LabelColor::value-changed](signal.LabelColor.value-changed.html)
