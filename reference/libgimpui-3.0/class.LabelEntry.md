...
[LabelEntry](class.LabelEntry.html#description)
...
# [GimpUi](index.html)LabelEntry

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimplabelentry.c#L34 "go to source location")

```
final class GimpUi.LabelEntry : GimpUi.Labeled {
  /* No available fields */
}
```
...
###### [gimp\_label\_entry\_new](ctor.LabelEntry.new.html)

No description available.

#### Instance methods

###### [gimp\_label\_entry\_get\_entry](method.LabelEntry.get_entry.html)

This function returns the `GtkEntry` packed in `entry`.

###### [gimp\_label\_entry\_get\_value](method.LabelEntry.get_value.html)

This function returns the value shown by `entry`.

###### [gimp\_label\_entry\_set\_value](method.LabelEntry.set_value.html)
...
###### [GimpUi.LabelEntry:value](property.LabelEntry.value.html)
...
###### [GimpUi.LabelEntry::value-changed](signal.LabelEntry.value-changed.html)
