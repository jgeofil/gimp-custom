...
[Button](class.Button.html#description)
...
# [GimpUi](index.html)Button

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpbutton.c#L31 "go to source location")

```
class GimpUi.Button : Gtk.Button {
...
* [GimpColorButton](class.ColorButton.html "ColorButton")
...
###### [gimp\_button\_new](ctor.Button.new.html)
...
###### [GimpUi.Button::extended-clicked](signal.Button.extended-clicked.html)
...
```
struct GimpUiButtonClass {
  GtkButtonClass parent_class;
  void (* extended_clicked) (
    GimpButton* button,
...
`extended_clicked: void (* extended_clicked) ( GimpButton* button, GdkModifierType modifier_state )`
:   No description available.
...
###### [GimpUi.ButtonClass.extended\_clicked](vfunc.Button.extended_clicked.html)
