...
[UnitComboBox](class.UnitComboBox.html#description)
...
# [GimpUi](index.html)UnitComboBox

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpunitcombobox.c#L32 "go to source location")
...
###### [gimp\_unit\_combo\_box\_new](ctor.UnitComboBox.new.html)

No description available.

###### [gimp\_unit\_combo\_box\_new\_with\_model](ctor.UnitComboBox.new_with_model.html)

No description available.

#### Instance methods

###### [gimp\_unit\_combo\_box\_get\_active](method.UnitComboBox.get_active.html)

Returns the `GimpUnit` currently selected in the combo box.

###### [gimp\_unit\_combo\_box\_set\_active](method.UnitComboBox.set_active.html)
...
```
struct GimpUiUnitComboBoxClass {
