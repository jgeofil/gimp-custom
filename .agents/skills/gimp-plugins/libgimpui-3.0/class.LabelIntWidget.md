...
[LabelIntWidget](class.LabelIntWidget.html#description)
...
# [GimpUi](index.html)LabelIntWidget

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimplabelintwidget.c#L34 "go to source location")

```
final class GimpUi.LabelIntWidget : GimpUi.Labeled {
  /* No available fields */
}
```
...
###### [gimp\_label\_int\_widget\_new](ctor.LabelIntWidget.new.html)
...
###### [gimp\_label\_int\_widget\_get\_widget](method.LabelIntWidget.get_widget.html)
...
###### [GimpUi.LabelIntWidget:value](property.LabelIntWidget.value.html)

The currently set value.

since: 3.0

###### [GimpUi.LabelIntWidget:widget](property.LabelIntWidget.widget.html)
...
###### [GimpUi.LabelIntWidget::value-changed](signal.LabelIntWidget.value-changed.html)
...
```
struct GimpUiLabelIntWidgetClass {
