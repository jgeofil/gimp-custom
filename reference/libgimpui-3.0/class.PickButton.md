...
[PickButton](class.PickButton.html#description)
...
# [GimpUi](index.html)PickButton

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimppickbutton.c#L55 "go to source location")

```
class GimpUi.PickButton : Gtk.Button {
...
###### [gimp\_pick\_button\_new](ctor.PickButton.new.html)
...
###### [GimpUi.PickButton::color-picked](signal.PickButton.color-picked.html)
...
`color_picked: void (* color_picked) ( GimpPickButton* button, const GeglColor* color )`
:   No description available.
...
###### [GimpUi.PickButtonClass.color\_picked](vfunc.PickButton.color_picked.html)
