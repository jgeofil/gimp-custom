...
[EnumLabel](class.EnumLabel.html#description)
...
# [GimpUi](index.html)EnumLabel

#### Description [[src]](https://gitlab.gnome.org/GNOME/gimp/-/blob/master/libgimpwidgets/gimpenumlabel.c#L33 "go to source location")

```
final class GimpUi.EnumLabel : Gtk.Label {
  /* No available fields */
}
```
...
###### [gimp\_enum\_label\_new](ctor.EnumLabel.new.html)
...
###### [gimp\_enum\_label\_set\_value](method.EnumLabel.set_value.html)
...
###### [GimpUi.EnumLabel:enum-type](property.EnumLabel.enum-type.html)

The `GType` of the enum.

since: 2.8

###### [GimpUi.EnumLabel:enum-value](property.EnumLabel.enum-value.html)
...
have been visited. It will then apply the #GTK\_STATE\_FLAG\_VISITED
when rendering this link, in addition to #GTK\_STATE\_FLAG\_LINK.
...
which is to call gtk\_show\_uri\_on\_window().
