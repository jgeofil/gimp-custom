...
- Added support for prompting with text, image, and audio data, also known as _multimodal_ prompting. To learn more, see [Prompting with media](https://ai.google.dev/gemini-api/docs/prompting_with_media).
